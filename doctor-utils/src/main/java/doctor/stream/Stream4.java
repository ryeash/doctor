...
import doctor.tuple.Tuple4Consumer;
import doctor.tuple.Tuple4Function;
import doctor.tuple.Tuple4Predicate;
...
public class Stream4<A, B, C, D> extends StreamExt<Tuple4<A, B, C, D>> {
    ...
    public <E> Stream5<A, B, C, D, E> affixRight(Tuple4Function<A, B, C, D, ? extends E> mapper) {
        return map5(t -> NTuple.of(t.first(), t.second(), t.third(), t.fourth(), mapper.apply(t)));
    }

    public <E> Stream5<A, B, C, D, E> flatAffixRight(Tuple4Function<A, B, C, D, Stream<? extends E>> mapper) {
        return new Stream5<>(flatMap(t -> mapper.apply(t).map(c -> NTuple.of(t.first(), t.second(), t.third(), t.fourth(), c))));
    }

    public <E> Stream5<E, A, B, C, D> affixLeft(Tuple4Function<A, B, C, D, ? extends E> mapper) {
        return map5(t -> NTuple.of(mapper.apply(t), t.first(), t.second(), t.third(), t.fourth()));
    }
}
