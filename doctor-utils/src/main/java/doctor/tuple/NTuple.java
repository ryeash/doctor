 ...
 */
public class NTuple implements Serializable, Comparable<NTuple>, Iterable<Object> {
    ...
    /**
     * Create a new tuple using the given object array. The array will be used directly (not copied), so
     * take care when editing the array after creation of this object.
     *
     * @param objects the objects that will constitute the tuple
     * @return a new {@link NTuple}
     */
    public static NTuple of(Object[] objects) {
    ...
    public boolean equals(Object o) {
        return o instanceof NTuple && Arrays.equals(values, ((NTuple) o).values);
    }
    ...
    public static final Comparator<Object> ANY_OBJECT = Comparator.nullsLast((a, b) -> {
        if (a instanceof Comparable && b instanceof Comparable && b.getClass().isInstance(a)) {
