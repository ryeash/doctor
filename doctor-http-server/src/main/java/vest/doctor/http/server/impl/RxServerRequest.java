...
public class RxServerRequest implements RxRequest {
    ...
    private final Pipeline<HttpContent> body;

    private Map<String, Cookie> cookies;
    private final Map<String, Object> attributes = new HashMap<>();

    public RxServerRequest(HttpRequest request, ChannelHandlerContext context, ExecutorService pool, Pipeline<HttpContent> body) {
    ...
    @Override
    public Pipeline<HttpContent> body() {
        return body;
    }

    @Override
    public Pipeline<Part> multiPartBody() {
        return new MultiPartReader(request).read(this);
    }
    ...
    @Override
    public RxResponse createResponse() {
        return new RxServerResponse(this);
    }
