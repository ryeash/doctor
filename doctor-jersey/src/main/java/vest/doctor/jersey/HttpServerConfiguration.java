...
final class HttpServerConfiguration {
     ...
     */
    private String tcpThreadNameFormat = "netty-tcp";
     ...
     */
    private String workerThreadFormat = "netty-worker";
    ...
    public String getTcpThreadNameFormat() {
        return tcpThreadNameFormat;
    }

    public void setTcpThreadNameFormat(String tcpThreadNameFormat) {
        this.tcpThreadNameFormat = tcpThreadNameFormat;
    }
